...
class OperatorWindow(BoxLayout):
  ...
  def update_purchases(self):
    ...
    if pcode == "1234" or pcode == "2345":
      ...
      code = Label(text=pcode,size_hint_x=.1)
      name = Label(text="Product One", size_hint_x=.3)
      qty = Label(text="1",size_hint_x=.1)
      disc = Label(text="0.00",size_hint_x=.2)
      price = Label(text="0.00",size_hint_x=.2)
      total = Label(text="0.00",size_hint_x=.3)
